...
##---------------------------------------------A------------------------------------------------------
#loading data
countries_data = ctn.convert('devoir2_code/relevant_csv/regressions/missing_regression_2_elastic.csv')
countries_num_data = np.delete(countries_data,0,axis=1)
countries_num_data = np.delete(countries_num_data,0,axis=0).astype(float)
